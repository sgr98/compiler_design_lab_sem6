...
{
       9,     0,    -1,    10,    -1,    10,    11,     4,    -1,    11,
       4,    -1,    12,     6,    12,     3,    -1,    12,     7,    12,
       3,    -1,     7,    12,     6,    12,     3,    -1,     7,    12,
       7,    12,     3,    -1,     5,    -1
};
...
{
  "$end", "error", "$undefined", "IOTA", "SCOL", "NUMBER", "'+'", "'-'",
  "$accept", "S", "A", "B", "C", 0
};
#endif
...
{
      -4,    -5,    -3,     4,    -4,     9,    -1,     1,    -5,    10,
      -5,    -3,    -3,    -3,    -3,    -5,    12,    13,    14,    15,
      -5,    -5,    -5,    -5
};
...
{
       7,     1,     1,     2,     8,    11,    12,    13,    14,    16,
      17,    18,    19,    10,    15,    20,    21,    22,    23,     0,
       9
};

static const yytype_int8 yycheck[] =
{
       2,     5,     5,     7,     0,     6,     7,     6,     7,    11,
      12,    13,    14,     4,     4,     3,     3,     3,     3,    -1,
       4
};
...
{
       0,     5,     7,     9,    10,    11,    12,    12,     0,    11,
       4,     6,     7,     6,     7,     4,    12,    12,    12,    12,
       3,     3,     3,     3
};
