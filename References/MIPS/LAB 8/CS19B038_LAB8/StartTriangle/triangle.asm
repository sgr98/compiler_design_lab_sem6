            ...
            section .text
_start:
            mov     rax, 1          ;rdx holds address of next byte to write
...
line:
            ...
            jng     line            ;not yet, keep writing on this line
lineDone:
            mov     byte [rdx], 10  ;write a new line char
            inc     rdx             ;and move pointer to where next 
            inc     r8              ;next line will be one char longer
            mov     r9, 0           ;reset count of stars written on this line
            cmp     r9, maxlines    ;wait, did we already finish the last line?
